...
const uint16_t PROGMEM combo_lparen[] = {KC_DOT, KC_M, COMBO_END};
const uint16_t PROGMEM combo_rparen[] = {KC_D, KC_W, COMBO_END};
const uint16_t PROGMEM combo_lbrack[] = {KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM combo_rbrack[] = {KC_W, KC_P, COMBO_END};
const uint16_t PROGMEM combo_lcbrck[] = {KC_Y, KC_U, COMBO_END};
const uint16_t PROGMEM combo_rcbrck[] = {KC_C, KC_G, COMBO_END};
const uint16_t PROGMEM combo_lparen2[] = {KC_SLSH, KC_MINS, COMBO_END};
const uint16_t PROGMEM combo_rparen2[] = {KC_EXLM, KC_AT, COMBO_END};
const uint16_t PROGMEM combo_lbrack2[] = {KC_GT, KC_COLN, COMBO_END};
const uint16_t PROGMEM combo_rbrack2[] = {KC_DLR, KC_PERC, COMBO_END};
const uint16_t PROGMEM combo_lcbrck2[] = {KC_QUES, KC_UNDS, COMBO_END};
const uint16_t PROGMEM combo_rcbrck2[] = {KC_AMPR, KC_ASTR, COMBO_END};
combo_t key_combos[] = {
    COMBO(combo_k, KC_K),
    COMBO(combo_q, KC_Q),
    COMBO(combo_z, KC_Z),
    ...
    COMBO(combo_lparen2, KC_LPRN),
    COMBO(combo_rparen2, KC_RPRN),
    COMBO(combo_lbrack2, KC_LBRC),
    COMBO(combo_rbrack2, KC_RBRC),
    COMBO(combo_lcbrck2, KC_LCBR),
    COMBO(combo_rcbrck2, KC_RCBR),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO, KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, KC_NO, KC_NO,    KC_NO, KC_NO,  KC_1, KC_2, KC_3, KC_0,  KC_NO,
    KC_NO, KC_NO,   KC_NO,   KC_NO,   MS_BTN3, KC_NO,                  KC_NO,  KC_7, KC_8, KC_9, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO,                                               KC_ENT, KC_0, KC_DOT
    ),
    [3] = LAYOUT_split_3x6_3_ex2(
    KC_NO, TO(8),   KC_HOME, KC_UP,   KC_END,  KC_NO, KC_NO,    KC_NO, KC_NO, TO(0),   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_NO, TO(3),   KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO,    KC_NO, KC_NO, KC_RCTL, KC_RSFT, KC_RGUI, KC_RALT, KC_NO,
    KC_NO, MS_BTN5, MS_BTN4, KC_PGDN, KC_PGUP, KC_NO,                  KC_NO, TO(1),   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_NO, KC_NO,   KC_NO,                                             KC_NO, KC_NO, KC_NO
    ),
    [4] = LAYOUT_split_3x6_3_ex2(
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,    KC_NO, KC_NO, KC_DLR,  KC_PERC, KC_CIRC, KC_NO,  KC_NO,
    KC_NO, KC_LALT, KC_LGUI, KC_LSFT, KC_LCTL, KC_NO, KC_NO,    KC_NO, KC_NO, KC_EXLM, KC_AT,   KC_HASH, KC_EQL, KC_NO,
    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                  KC_NO, KC_AMPR, KC_ASTR, KC_PLUS, KC_NO,  KC_NO,
    KC_NO, KC_NO, KC_NO,                                               KC_NO, KC_NO, KC_DEL
    ),
    [5] = LAYOUT_split_3x6_3_ex2(
    KC_NO, KC_DQUO, KC_LT,   KC_GT,   KC_COLN, KC_NO, KC_NO,    KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_NO, KC_GRV,  KC_BSLS, KC_SLSH, KC_MINS, KC_NO, KC_NO,    KC_NO, KC_NO, KC_RCTL, KC_RSFT, KC_RGUI, KC_RALT, KC_NO,
    KC_NO, KC_TILD, KC_PIPE, KC_QUES, KC_UNDS, KC_NO,                  KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
    KC_NO, KC_NO, KC_NO,                                               KC_NO, KC_NO, KC_NO
    ),
    ...
    KC_NO, MS_WHLL, MS_WHLR, MS_WHLD, MS_WHLU, KC_NO,                  RM_SPDD, RM_NEXT, RM_PREV, RM_HUEU, RM_HUED, KC_NO,
